          ...
          <div className="bg-white rounded-3xl p-8 w-full max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {[
                ...
                { id: \'image_url\', label: \'URL Gambar\', type: \'url\', placeholder: \'https://images.unsplash.com/...\' },
              ...
              {form.image_url && (
                <div>
                  <label className="text-xs font-semibold text-[#8C7B6B] uppercase tracking-wider block mb-1.5">Preview Gambar</label>
                  <img src={form.image_url} alt="preview" className="w-full h-40 object-cover rounded-xl border border-[#E8E0D5]" />
                </div>
              )}
              <div className="flex gap-3 pt-2">
                ...
                <button type="submit" disabled={saving} className="flex-1 btn-primary py-3 rounded-full text-sm font-semibold disabled:opacity-50">
...
os.makedirs('app/admin/products', exist_ok=True)
with open('app/admin/products/page.jsx', 'w', encoding='utf-8') as f:
    f.write(content)
print('Done')
