    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-6 bg-[#F8F5F0]">
        <div className="w-full max-w-md text-center">
          ...
          <h2 className="text-2xl font-bold text-[#1A1208] mb-2">Cek Email Kamu!</h2>
          <p className="text-[#8C7B6B] mb-6">Kami kirim link konfirmasi ke <strong>{form.email}</strong>. Klik link tersebut untuk mengaktifkan akun.</p>
    ...
    <div className="min-h-screen flex items-center justify-center px-6 bg-[#F8F5F0]">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="w-14 h-14 rounded-full bg-[#E85D26] flex items-center justify-center mx-auto mb-4">
            <span className="text-white text-2xl font-bold">W</span>
          </div>
          <h1 className="text-2xl font-bold text-[#1A1208]">Daftar ke WarungKu</h1>
          <p className="text-[#8C7B6B] text-sm mt-1">Buat akun dan mulai pesan sekarang!</p>
        </div>
